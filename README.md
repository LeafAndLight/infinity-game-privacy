...
- (if enabled) participate in online leaderboards.
...
- In-App Purchases via the Meta Store  
- Online entitlement checks for ownership of the game and add-ons  
- (If enabled) Official Meta online leaderboard and cloud saves
...
We also do **not** intentionally collect:

- voice recordings from the headset microphone,  
- photos or videos created outside normal Quest system behavior,  
- biometric data beyond what Meta already processes for tracking, or  
- any user-generated content unrelated to game progress.

Any such data that Meta processes is governed by Meta’s own privacy policy.
...
- product identifier (for example: `gold_key`),  
- status of the purchase (completed, refunded, etc.),  
- that the purchase belongs to your Meta account (through USER_ID), and  
- timestamps or other metadata provided by Meta.

We use this IAP data only to:

- unlock and deliver the purchased content in the game,  
...
- complete purchase history for other apps.

All payment processing is handled by Meta.
...
- your scores and related game stats (for example: max height reached, time, or similar metrics), and  
...
Player progress is stored only:

- locally on your Meta Quest device, and  
- optionally, in Meta’s cloud-save system if that feature is enabled for your account.

Save data may include:

- your current position or height,  
- items owned (for example: Golden Key, coins, other in-game resources),  
- vending machine or chest states,  
...
## 5. Online Connectivity and Leaderboards
...
When using the official Meta leaderboard, the following applies:
...
- does not independently process your financial information.

We only receive confirmation from Meta that:

- a specific product or add-on has been purchased by your account, or  
- a previous purchase is still valid (entitlement check).

We use this information only to unlock and maintain access to the purchased content inside the game.
...
### 8.1 Deleting Save Data Yourself
...
Please include enough information to identify your account, such as:
...
Some data is controlled directly by Meta, including:

- your Meta account information,  
- your platform-level purchase history, and  
- platform analytics and telemetry.

To delete this data, you must use the privacy tools in your Meta account or contact Meta Support.  
If you are unsure which data we can delete and which data Meta controls, you can email us and we will explain your options.
...
We may update this Privacy Policy from time to time, for example if we add new online features such as additional leaderboards or services.
